                ...
                Fieldset::make('Skills')
                    ->schema([
                        Forms\Components\TagsInput::make('skills')
                            ...
                            ->helperText("Top 5 recommended. Also appears in the Skills section.")
                            ->suggestions([
                                'Laravel', 'PHP', 'JavaScript', 'React', 'Next.js', 'TypeScript',
                                'MySQL', 'PostgreSQL', 'TailwindCSS', 'Git', 'REST API'
                            ])
                            ->columnSpanFull(),
                    ]),
